...
- 보일러 점검 및 청소
- 배관 보온재 교체
- 안전밸브 교체', '(주)열관리시스템', '2024-03-15', '2024-04-30', '박현장', 'planned'),

('전체동 소방시설 점검', '전 건물 소방시설 정기점검
- 스프링클러 시스템 점검
- 화재감지기 교체
- 소화기 점검 및 교체', '(주)안전소방', '2024-04-01', '2024-04-15', '최현장', 'planned');
...
SELECT 
  ...
  (SELECT COUNT(*) FROM construction_plans) as construction_plans,
