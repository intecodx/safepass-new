...
export default function WieStatisticsPage() {
          ...
          <Card className="h-full min-w-0">
            ...
            <CardContent className="flex justify-center">
              <DonutChart
                ...
                centerLabel="명"
                colors={["#eab308", "#8b5cf6", "#10b981", "#ef4444"]}
                data={[
                  { label: "승인대기", value: statistics.statusBreakdown.pending, color: "#eab308" },
                  { label: "승인완료", value: statistics.statusBreakdown.approved, color: "#8b5cf6" },
            ...
            <CardContent className="flex justify-center">
              <DonutChart
                ...
                data={statistics.companyBreakdown.slice(0, 5).map((item, index) => ({
                  label: item.company,
                  value: 1,
                  color: ["#10b981", "#8b5cf6", "#f59e0b", "#ef4444", "#3b82f6"][index] || "#6b7280",
                }))}
              />
            </CardContent>
          </Card>
              ...
              {statistics.dailyStats.map((day, index) => (
                <div key={index} className="text-center space-y-2">
                  ...
                  <div className="space-y-1">
                    <div className="text-xs text-purple-600">신청 {day.registrations}</div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center justify-between p-4 bg-purple-50 rounded-lg">
                  ...
                  <div className="text-right">
                    <div className="text-2xl font-bold text-purple-600">{statistics.nationalityBreakdown.domestic}</div>
